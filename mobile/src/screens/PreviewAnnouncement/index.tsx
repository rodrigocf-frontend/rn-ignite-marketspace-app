...
export function PreviewAnnouncement() {
  ...
  return (
    <>
      <VStack
        className="pb-6  items-center bg-primary-0 flex-1 justify-center"
        style={{
          paddingTop: insets.top + 40,
        }}
      >
        <Text className="text-typography-0 font-karla_bold text-base flex-1 text-center ">
          Pré visualização do anúncio
        </Text>
        <Text className="text-typography-0 font-karla  text-sm flex-1 text-center ">
      ...
      <Box className="bg-background-0 pt-5 pb-7 px-6">
        <HStack className="items-center justify-between h-fit gap-3">
          <ContainedButton variant="SECONDARY" IconButton={ArrowLeftIcon}>
            Voltar e editar
          </ContainedButton>
          <ContainedButton IconButton={TagIcon}>Publicar</ContainedButton>
        </HStack>
      </Box>
    </>
  );
